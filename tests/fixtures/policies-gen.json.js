app.PolicyEditorConfig={
  ...
  "serviceMap": {
    ...
    "AWS Backup": {
      ...
      "ARNFormat": "arn:aws:backup:<region>:<account-id>:<resource-type>:<resource_name>",
    ...
    "Amazon Elastic File System": {
      ...
      "ARNFormat": "arn:${Partition}:elasticfilesystem:${Region}:${Account}:file-system/${FileSystemId}",
    ...
    "Amazon FreeRTOS": {
      ...
      "ARNFormat": "arn:aws:freertos:<region>:<account_ID>:<type>/<name>",
